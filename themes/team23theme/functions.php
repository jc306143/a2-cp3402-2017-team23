...
function team23theme_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'team23theme' ),
	) );
...
function team23theme_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'team23theme' ),
...
function team23theme_scripts() {
	...
	wp_enqueue_script( 'team23theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
